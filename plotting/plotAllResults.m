...
parfor i = 1:length(whichElectrodes)
    ...
    for j = 1:length(Units)
        ...
        tCurve = StatsUnit.TCurve(StatsUnit.CondNo);
...
%                 '-png', '-nocrop', '-m2', TCurveFig);
            ...
            if ~(isempty(findstr(fileName,'R')) || ...
                ...
                StatsUnit.CondNo = VelConditionNo;
...
%                     '-png', '-nocrop', '-m2', VelCurveFig);
            ...
            if summaryFig == 1 && tmpParams.NoOfElectrodes>1
                ...
                % Set up subplots
                if tmpParams.NoOfElectrodes==2
                    sub = subplot(1,2,i);
                elseif tmpParams.NoOfElectrodes==3 || tmpParams.NoOfElectrodes==4
                    sub = subplot(2,2,i);
                else
                    sub = subplot(ceil((tmpParams.NoOfElectrodes)/4),4,i);
                end
