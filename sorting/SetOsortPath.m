...
%basepathCode=[filesep 'svnwork/code/osort-v3-rel' filesep];   % change this path

basepathCode=['C:\Users\leo\Documents\MATLAB\Toolboxes\osort-v3-rel' filesep];   % change this path
...
path(path,[basepathCode '/code/continuous/binLeadpoint']);
